## Pantalla de configuración inicial donde el jugador elige nombre, pronombres y nombre de la cafetería.
## Resetea GameState al entrar para garantizar que es siempre una partida nueva.
## Al confirmar, inicia la historia desde el principio con una transición de vídeo.
extends Control
...
# Actualiza el pronombre seleccionado y refresca los botones visualmente.
