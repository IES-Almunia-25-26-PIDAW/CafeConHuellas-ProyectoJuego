...
# StickerManager: Es un nodo hijo del menú principal
# Lee los finales desbloqueados de GlobalSave al entrar a la escena y añade los stickers correspondientes como sprites hijos de un contenedor
...
# El nodo padre donde se instanciarán los stickers como hijos. (TODO)
# Asígnalo en el inspector apuntando a un Node2D de tu escena.
