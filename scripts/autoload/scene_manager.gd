...
# ColorRect negro para las animaciones de transición de escenas
...
func _ready() -> void:
	...
	# Hacemos que el ColorRect ocupe todo el CanvasLayer (la pantalla entera)
...
# Cambio normal de escena de godot
